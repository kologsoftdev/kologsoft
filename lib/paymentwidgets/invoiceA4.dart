...
class ReceiptA4Printer {
  static PdfPageFormat getFormat(String size) {
    return PdfPageFormat.a4;
  }

  Future<pw.Document> buildA4Pdf(
      ReceiptData data, {
    ...
    final qrSize = contentWidth * 0.18;
    final barcodeWidth = contentWidth * 0.5;
    final barcodeHeight = 44.0;
  ...
  Future<PrintResult> printA4Pdf({
    ...
    final doc = await buildA4Pdf(data, pageFormat: pageFormat);
