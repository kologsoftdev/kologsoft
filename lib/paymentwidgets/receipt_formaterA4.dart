...
import 'PDFprints/print_service.dart';
import '../models/Receiptdatamodel.dart';

class ReceiptPrinterA4 {
  static PdfPageFormat getFormat(String size) {
    return PdfPageFormat.a4;
  }

  Future<pw.Document> buildPdfA4(
      ReceiptData data, {
    ...
    final pageMargin = 10.0;
    final cardPadding = 14.0;
    final contentWidth = pageFormat.width - (pageMargin * 2) - (cardPadding * 2);
    final barcodeWidth = contentWidth * 0.6;
    final barcodeHeight = 50.0;
        ...
        children: [
          ...
          pw.Center(
            child: pw.BarcodeWidget(
              ...
              drawText: true,
              textStyle: pw.TextStyle(font: ttfRegular, fontSize: 8),
            ),
          ),
          pw.SizedBox(height: 10),
  ...
  Future<PrintResult> printA4Pdf({
    required String printerName,
    required ReceiptData data,
    PdfPageFormat pageFormat = PdfPageFormat.a4,
  }) async {
    final doc = await buildPdfA4(data, pageFormat: pageFormat);
    return await PrintService.printPdf(printerName: printerName, pdf: doc);
  }
