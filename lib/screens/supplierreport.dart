...
class _SupplierReportState extends State<SupplierReport> {
  ...
  void initState() {
    ...
    Future.microtask(() {
      ...
      context.read<Datafeed>().fetchSupplierReport(selectedDate: selectedDate);
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<Datafeed>(
      builder: (context, value, child) {
        final resultList     = value.filteredSupplierReport();

        final totals = value.filteredSupplierTotals();
        final totalGross     = totals['totalGross']    ?? 0.0;
        final totalNet       = totals['totalNet']      ?? 0.0;
        final totalDiscount  = totals['totalDiscount'] ?? 0.0;
        final totalTax       = totals['totalTax']      ?? 0.0;
        final totalPurchases = totals['totalCount']    ?? 0.0;
        final totalReturns   = totals['totalReturns']  ?? 0.0;
        final totalCash      = totals['totalCash']         ?? 0.0;
        final totalCredit    = totals['totalCredit']       ?? 0.0;
        final totalOpening   = totals['totalOpeningStock'] ?? 0.0;
            ...
            actions: [
              ReusableDatePickerWidget(
                onDateSelected: (sel) {
                  ...
                  context.read<Datafeed>().fetchSupplierReport(
              ...
              child: ConstrainedBox(
                ...
                child: Column(
                  children: [
                          ...
                          if (isMobile) ...[
                            ...
                            SizedBox(
                              ...
                              child: ElevatedButton.icon(
                                ...
                                onPressed: () => _printSupplierSummary(
                                  resultList,
                                  totals,
                    ...
                    Expanded(
                      child: value.isLoadingSupplierReport
                          ? Center(
                          child: CircularProgressIndicator(
                              color: colorScheme.primary))
                          : resultList.isEmpty
                          ? Center(
                          child: Text('No supplier transactions found',
                              style: textTheme.bodyMedium?.copyWith(
                        ...
                        builder: (context, constraints) {
                          ...
                          if (isDesktop) {
                            ...
                            return LayoutBuilder(
                              builder: (context, constraints) {
                                const widths = [32, 160, 90, 90, 90, 120, 90, 100, 90, 80, 100];
                                const gap = 24.0;
                                          ...
                                          children: [
                                            Container(
                                              ...
                                              child: rowOf([
                                                ...
                                                Text('Supplier', style: textTheme.bodyMedium?.copyWith(color: colorScheme.onSurface, fontWeight: FontWeight.bold)),
                                                Text('Purchases', style: textTheme.bodyMedium?.copyWith(color: colorScheme.onSurface, fontWeight: FontWeight.bold)),
                                                Text('Cash', style: textTheme.bodyMedium?.copyWith(color: colorScheme.onSurface, fontWeight: FontWeight.bold)),
                                                Text('Credit', style: textTheme.bodyMedium?.copyWith(color: colorScheme.onSurface, fontWeight: FontWeight.bold)),
                                                Text('Opening Stock', style: textTheme.bodyMedium?.copyWith(color: colorScheme.onSurface, fontWeight: FontWeight.bold)),
                                                Text('Returns', style: textTheme.bodyMedium?.copyWith(color: colorScheme.onSurface, fontWeight: FontWeight.bold)),
                                                Text('Gross', style: textTheme.bodyMedium?.copyWith(color: colorScheme.onSurface, fontWeight: FontWeight.bold)),
                                                Text('Discount', style: textTheme.bodyMedium?.copyWith(color: colorScheme.onSurface, fontWeight: FontWeight.bold)),
                                                Text('Tax', style: textTheme.bodyMedium?.copyWith(color: colorScheme.onSurface, fontWeight: FontWeight.bold)),
                                                Text('Net Value', style: textTheme.bodyMedium?.copyWith(color: colorScheme.onSurface, fontWeight: FontWeight.bold)),
                                              ]),
                                            ),
                                                      ...
                                                      return rowOf(
                                                        [
                                                          ...
                                                          Text(totalCredit.toStringAsFixed(2),
                                                              style: textTheme.bodyMedium?.copyWith(color: colorScheme.onSurface)),
                                                          Text(totalOpening.toStringAsFixed(2),
                                                              style: textTheme.bodyMedium?.copyWith(color: colorScheme.onSurface)),
                                                          Text(totalReturns.toStringAsFixed(0),
                                                              style: textTheme.bodyMedium?.copyWith(color: colorScheme.onSurface)),
                                                          Text(totalGross.toStringAsFixed(2),
                                                              style: textTheme.bodyMedium?.copyWith(color: colorScheme.onSurface)),
                                                      ...
                                                      child: rowOf(
                                                        [
                                                          ...
                                                          Text(row['supplierName'] ?? '',
                                                              style: textTheme.bodyMedium?.copyWith(color: colorScheme.onSurface)),
                                                          Text(((row['purchaseCount'] ?? 0.0) as double).toStringAsFixed(0),
                                                              style: textTheme.bodyMedium?.copyWith(color: colorScheme.onSurface)),
                                                          Text(((row['cashAmount'] ?? 0.0) as double).toStringAsFixed(2),
                                                              style: textTheme.bodyMedium?.copyWith(color: colorScheme.onSurface)),
                                                          Text(((row['creditAmount'] ?? 0.0) as double).toStringAsFixed(2),
                                                              style: textTheme.bodyMedium?.copyWith(color: colorScheme.onSurface)),
                                                          Text(((row['openingStockAmount'] ?? 0.0) as double).toStringAsFixed(2),
                                                              style: textTheme.bodyMedium?.copyWith(color: colorScheme.onSurface)),
                                                          Text(((row['returnCount'] ?? 0.0) as double).toStringAsFixed(0),
                                                              style: textTheme.bodyMedium?.copyWith(color: colorScheme.onSurface)),
                                                          Text((row['gross'] as double).toStringAsFixed(2),
                                                              style: textTheme.bodyMedium?.copyWith(color: colorScheme.onSurface)),
                                                          Text((row['discount'] as double).toStringAsFixed(2),
                                                              style: textTheme.bodyMedium?.copyWith(color: colorScheme.onSurface)),
                                                          Text((row['tax'] as double).toStringAsFixed(2),
                                                              style: textTheme.bodyMedium?.copyWith(color: colorScheme.onSurface)),
                                                          Text((row['net'] as double).toStringAsFixed(2),
                                                              style: textTheme.bodyMedium?.copyWith(color: colorScheme.onSurface)),
                                                        ],
                                    ...
                                    children: [
                                      ...
                                      Wrap(
                                        ...
                                        children: [
                                          _miniStat(context,
                                              'Purchases',
                                              ((row['purchaseCount'] ?? 0.0) as double)
                                                  .toStringAsFixed(0)),
                                          _miniStat(context,
                                              'Returns',
                                              ((row['returnCount'] ?? 0.0) as double)
                                                  .toStringAsFixed(0)),
                                          _miniStat( context,
                                              'Cash',
                                              ((row['cashAmount'] ?? 0.0) as double)
                                                  .toStringAsFixed(2)),
                                          _miniStat( context,
                                              'Credit',
                                              ((row['creditAmount'] ?? 0.0) as double)
                                                  .toStringAsFixed(2)),
                                          _miniStat( context,
                                              'Opening Stock',
                                              ((row['openingStockAmount'] ?? 0.0) as double)
                                                  .toStringAsFixed(2)),
                                          _miniStat( context,
                                              'Gross',
                                              (row['gross'] as double)
                            ...
                            child: Column(
                              ...
                              children: [
                                Container(
                                  ...
                                  child: rowOf([
                                    Text('#', style: dialogTheme.textTheme.bodyMedium?.copyWith(color: dialogTheme.colorScheme.onSurface, fontWeight: FontWeight.bold)),
                                    Text('Date', style: dialogTheme.textTheme.bodyMedium?.copyWith(color: dialogTheme.colorScheme.onSurface, fontWeight: FontWeight.bold)),
                                    Text('Invoice', style: dialogTheme.textTheme.bodyMedium?.copyWith(color: dialogTheme.colorScheme.onSurface, fontWeight: FontWeight.bold)),
                                    Text('Waybill', style: dialogTheme.textTheme.bodyMedium?.copyWith(color: dialogTheme.colorScheme.onSurface, fontWeight: FontWeight.bold)),
                                    Text('Type', style: dialogTheme.textTheme.bodyMedium?.copyWith(color: dialogTheme.colorScheme.onSurface, fontWeight: FontWeight.bold)),
                                    Text('Branch', style: dialogTheme.textTheme.bodyMedium?.copyWith(color: dialogTheme.colorScheme.onSurface, fontWeight: FontWeight.bold)),
                                    Text('Staff', style: dialogTheme.textTheme.bodyMedium?.copyWith(color: dialogTheme.colorScheme.onSurface, fontWeight: FontWeight.bold)),
                                    Text('Gross', style: dialogTheme.textTheme.bodyMedium?.copyWith(color: dialogTheme.colorScheme.onSurface, fontWeight: FontWeight.bold)),
                                    Text('Discount', style: dialogTheme.textTheme.bodyMedium?.copyWith(color: dialogTheme.colorScheme.onSurface, fontWeight: FontWeight.bold)),
                                    Text('Tax', style: dialogTheme.textTheme.bodyMedium?.copyWith(color: dialogTheme.colorScheme.onSurface, fontWeight: FontWeight.bold)),
                                    Text('Net', style: dialogTheme.textTheme.bodyMedium?.copyWith(color: dialogTheme.colorScheme.onSurface, fontWeight: FontWeight.bold)),
                                    Text('Items', style: dialogTheme.textTheme.bodyMedium?.copyWith(color: dialogTheme.colorScheme.onSurface, fontWeight: FontWeight.bold)),
                                  ]),
                                ),
                                Divider(height: 0.5, thickness: 0.5, color: dialogTheme.colorScheme.outline.withOpacity(0.1)),
                                Expanded(
                                  child: Scrollbar(
                                      ...
                                      itemBuilder: (context, index) {
                                        ...
                                        return InkWell(
                                          ...
                                          child: rowOf(
                                            [
                                              Text('${index + 1}',
                                                  style: dialogTheme.textTheme.bodyMedium?.copyWith(color: dialogTheme.colorScheme.onSurface)),
                                              Text(t['date'] ?? '-',
                                                  style: dialogTheme.textTheme.bodyMedium?.copyWith(color: dialogTheme.colorScheme.onSurface)),
                                              Text(t['invoice'] ?? '-',
                                                  style: dialogTheme.textTheme.bodyMedium?.copyWith(color: dialogTheme.colorScheme.onSurface)),
                                              ...
                                              Text(((t['gross'] as num?)?.toDouble() ?? 0).toStringAsFixed(2),
                                                  style: dialogTheme.textTheme.bodyMedium?.copyWith(color: dialogTheme.colorScheme.onSurface)),
                                              Text(((t['discount'] as num?)?.toDouble() ?? 0).toStringAsFixed(2),
                                                  style: dialogTheme.textTheme.bodyMedium?.copyWith(color: dialogTheme.colorScheme.onSurface)),
                                              Text(((t['tax'] as num?)?.toDouble() ?? 0).toStringAsFixed(2),
                                                  style: dialogTheme.textTheme.bodyMedium?.copyWith(color: dialogTheme.colorScheme.onSurface)),
                                              Text(((t['netval'] as num?)?.toDouble() ?? 0).toStringAsFixed(2),
                                                  style: dialogTheme.textTheme.bodyMedium?.copyWith(color: dialogTheme.colorScheme.onSurface)),
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: SizedBox(
          ...
          child: items.isEmpty
            ...
            'No items',
            style: dialogTheme.textTheme.bodyMedium?.copyWith(
              color: dialogTheme.colorScheme.onSurface.withOpacity(0.72),
            ),
          )
              : LayoutBuilder(
            builder: (context, constraints) {
                  ...
                  rows: items.asMap().entries.map((e) {
                    ...
                    return DataRow(
                      ...
                      cells: [
                        ...
                        DataCell(
                            Text(item['stockingmode']?.toString() ?? '-')),
                        DataCell(
