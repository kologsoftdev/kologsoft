...
class CropRegistration extends StatefulWidget {
  ...
  const CropRegistration({Key? key,this.docId, this.data}) : super(key: key);

  @override
  State<CropRegistration> createState() => _CropRegistrationState();
}

class _CropRegistrationState extends State<CropRegistration> {
    ...
    return Consumer<Datafeed>(
      builder: (BuildContext context, Datafeed value, Widget? child) {
        ...
        return Scaffold(
          ...
          appBar: AppBar(
            title: Text(widget.docId != null ? "Edit Crop" : "Register Crop"),
