...
class LanguageRegistration extends StatefulWidget {
  final String? docId;
  final Map<String, dynamic>? data;
  const LanguageRegistration({Key? key,this.docId, this.data}) : super(key: key);

  @override
  State<LanguageRegistration> createState() => _LanguageRegistrationState();
}

class _LanguageRegistrationState extends State<LanguageRegistration> {
    ...
    return Consumer<Datafeed>(
      builder: (BuildContext context, Datafeed value, Widget? child) {
        ...
        return Scaffold(
          ...
          appBar: AppBar(
            title: Text(widget.docId != null ? "Edit Language" : "Register Language"),
                                  ...
                                  SizedBox(
                                    ...
                                    child: ElevatedButton(
                                      ...
                                      onPressed: _isLoading
                                        ...
                                        try {
                                          LanguageModel newMode = LanguageModel(
                                            name: name,
                                            staff: value.staff,
                                            id:id,
                                            date: DateTime.now(),
