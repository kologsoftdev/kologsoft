...
import 'package:kologsoft/screens/viewCrops.dart';
import 'package:kologsoft/screens/vieweducationlevel.dart';
...
import 'languagelistpage.dart';

class EducationLevelRegistration extends StatefulWidget {
  final String? docId;
  final Map<String, dynamic>? data;
  const EducationLevelRegistration({Key? key,this.docId, this.data}) : super(key: key);

  @override
  State<EducationLevelRegistration> createState() => _EducationLevelRegistrationState();
}

class _EducationLevelRegistrationState extends State<EducationLevelRegistration> {
    ...
    return Consumer<Datafeed>(
      builder: (BuildContext context, Datafeed value, Widget? child) {
        ...
        return Scaffold(
          ...
          appBar: AppBar(
            title: Text(widget.docId != null ? "Edit Level of Education" : "Register Level of Education"),
                                  ...
                                  SizedBox(
                                    ...
                                    child: ElevatedButton(
                                      ...
                                      onPressed: _isLoading
                                        ...
                                        try {
                                          EducationModel newMode = EducationModel(
                                            name: name,
                                            staff: value.staff,
                                            id:id,
                                            date: DateTime.now(),
                                    ...
                                    child: OutlinedButton.icon(
                                      ...
                                      onPressed: () {
                                        Navigator.push(
                                          context,
                                          MaterialPageRoute(
                                              builder: (_) => EducationLevelListPage()),
                                        );
                                      },
                                    ),
                                  ),
