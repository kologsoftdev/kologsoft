...
class finishedStockPage extends StatefulWidget {
  const finishedStockPage({super.key});

  @override
  State<finishedStockPage> createState() => _finishedStockPageState();
}

class _finishedStockPageState extends State<finishedStockPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final stockreport = provider.filterFinishedstockreport();
  ...
  Widget _buildStockTable() {
    final provider = context.watch<Datafeed>();
    final reportData = provider.filterFinishedstockreport();
